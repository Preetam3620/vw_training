...
@Component
class MySpringBean1 implements InitializingBean, DisposableBean, ApplicationContextAware {
	private String message;
	private ApplicationContext ctx;

	public MySpringBean1(String message) {
	...
	public void destroy() {
		System.out.println("disposable bean1 interface - destroy method called..");
	}
